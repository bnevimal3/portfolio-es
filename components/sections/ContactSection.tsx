    ...
    >
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-start">
        <div className="text-center md:text-left">
            ...
            Actualmente estoy abierto a nuevas oportunidades. No dudes en contactarme por correo electrónico o conectar conmigo en las redes sociales. ¡Me encantaría saber de ti!
            </p>
